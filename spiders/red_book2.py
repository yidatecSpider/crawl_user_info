...
def get_proxy():
    with open('../common/proxy2', 'r') as fp:
        proxy = fp.readline()
    return {
        'http': proxy,
        'https': proxy,
...
def request_query(url):
    ...
    try:
        ...
        while rsp.status_code == 461 or rsp.status_code == 502:
...
def main():
    ...
    and create_time < '2022-01-08 00:00:00' order by create_time desc limit 80001,120000 ''')
